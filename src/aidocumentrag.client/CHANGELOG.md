...
- Create Angular project with ng: `ng new aidocumentrag.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aidocumentrag.client.esproj`).
